...
import '../widgets/foul_indicator.dart';
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              // Score display section - this is where we apply the new structure
              Expanded(
                child: Container(
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    children: [
                      // Top row - Foul indicators (1/4 height)
                      Expanded(
                        flex: 1,
                        child: Center(
                          child: FoulIndicator(
                            consecutiveFouls: gameController
                                .state.consecutiveFouls[widget.playerIndex],
                            isActivePlayer:
                                widget.playerIndex + 1 == state.activePlayer,
                          ),
                        ),
                      ),

                      // Middle row - Score display (1/2 height)
                      Expanded(
                        flex: 3,
                        child: FittedBox(
                          fit: BoxFit.contain,
                      ...
                      // Bottom row - Empty space (1/4 height)
                      Expanded(
                        flex: 1,
                        child: SizedBox(), // Empty space as required
                      ),
                    ],
                  ),
                ),
              ...
              // Original player name with break indicator
              Row(
